...
import { deleteSchema, getUserSchema, forgetPasswordSchema } from './user.validation.js';
...
router.patch("/changePassword", auth(), validation(forgetPasswordSchema), changePassword)
